...
description: Comprehensive draft and post access, creating, editing and analysis. When Codex needs to work with the Ghost Admin API to access content published on alt-counsel.com as Houfu's partner.
---
