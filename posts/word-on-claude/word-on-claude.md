---
title: 'Word on Claude: The Lawyer''s Greatest Legal Tech Tool Strikes Back'
slug: word-on-claude-the-lawyers-greatest-legal-tech-tool-strikes-back
tags:
  - AI
  - LegalTech
  - MicrosoftOffice
...
Am I about to be very wrong?

At the start of the year, I boldly predicted that in 2026 we would reach a stage where contract reviews can be performed without opening Microsoft Word. *”No Word plugins, no hand-writing edits. Just prompting AI to output what I want.”* Success was clearly defined: if I had to open Word to make an edit, we are not there yet.

It is April 2026. Fresh from [Legal Skills](https://www.alt-counsel.com/so-you-want-to-claude-cowork-the-legal-plugin-a-guide/) — the February Cowork plugin that wiped an estimated $285B from legal tech market caps in a single trading session — Anthropic shipped Claude for Word. It prominently featured contract review as its flagship use case. Native sidebar. Tracked changes. Claude ❤️ Word?

{{< bookmark url="https://www.alt-counsel.com/my-2026-legal-ai-predictions-from-the-trenches-not-the-boardroom/" title="My 2026 Legal AI Predictions (From the Trenches, Not the Boardroom)" description="Five predictions grounded in actual practice, testable through the year. Prediction #1: complete routine contract reviews without opening Word." >}}

Throwing off the yoke of being bound to silly predictions, I decided to install Word and run the Claude plugin once it was available to Pro and Max subscribers. I was curious as to what this means for lawyers and their love-hate relationship with the greatest legal tech tool of all time -- Microsoft Word. 

## The Quick Verdict

So what do I think after trying to use it to edit contracts?

The product is good. Easy install — if you've ever used a Word plugin, this is familiar. The agentic editing capabilities are stronger than any other AI solution I've tried in Word. You can follow its work as it processes your prompt, complete with track changes. 
...
When thinking about how to write reviews, I like to think from the perspective of the user this product is made for. It’s clarifying for reasons you don’t expect.

And that story begins with me helping my mom with her training Powerpoint slides.

She'd tried Copilot first. Sure, it reads your instructions. But the product was so far away from what she needed, it was useless. She'd tried Meta (the one you find inside WhatsApp). Same thing. 

So I introduced her to Claude. Claude was a huge step up. But here's what I noticed as we worked.
...
## The Thesis: Interface Signals the Work
...
But here's the twist. The customisation doesn't happen in Word. You write the skills in markdown. You design the playbook in a text editor or the Claude web interface — as I did for [CoDraft](https://www.alt-counsel.com/two-files-one-workflow-no-code-just-cowork/), two text files doing document workflow without Word anywhere in the stack. You test prompts somewhere else. The plugin is where the customisation runs — not where it's written. You can also run them on the web interface. 

So Alexios and I converge in a way neither of us said out loud. Claude for Word isn't a drop-in replacement for Copilot or Harvey. It's a commitment to do the senior work — outside Word — that produces the skills the plugin will eventually run.

The playbook is written somewhere else. So is the deal thinking.
