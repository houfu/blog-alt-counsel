...
# Read the keyword frequency data
df = pd.read_csv('sglawwatch_query4.csv')
...
# Add vertical line at October 3
fig.add_vline(
    x='2025-10',
    line_width=2,
    line_dash="dash",
    line_color="rgba(200, 83, 107, 0.5)",
    annotation_text="Oct 3: $800 Fine",
    annotation_position="top",
    annotation_font_size=12,
    annotation_font_color="#C8536B"
)
...
fig.write_image(
    'keyword_timeline_chart.png',
    width=1200,
    height=600,
    scale=2  # 2x for retina displays
)
print("✅ Chart saved as: keyword_timeline_chart.png")

# Also save as HTML for interactive preview
fig.write_html('keyword_timeline_preview.html')
print("✅ Interactive preview saved as: keyword_timeline_preview.html")
