...
![A chart showing keyword mentions relating to AI adoption vs AI accountability from April 2025 to December 2025. From October 2025, a marked shift from AI adoption to AI accountability is noted.](https://www.alt-counsel.com/content/images/2025/12/keyword_timeline_chart.png)
...
![A screenshot of a news article on the Straits Times highlighting training for young lawyers on among other things, ethical use of AI.](https://www.alt-counsel.com/content/images/2025/12/Screenshot-2025-12-28-at-9.18.45---PM.png)
...
![](https://www.alt-counsel.com/content/images/2025/12/Screenshot-2025-12-28-at-10.48.29---PM.png)
...
This analysis only became possible because I've spent the past year building [data.zeeker.sg](https://data.zeeker.sg)—a structured, queryable database of Singapore legal news. Here's how you can replicate this kind of analysis yourself.

### *💻 *Step 1: The Wrong First Query

I started with what seemed obvious:

**Problem:** This caught false positives like "fl**ai**l," "Th**ai**land," "av**ai**lable."
...
![A screenshot of data.zeeker.sg showing how running a SQL query to read the summary of relevant articles may look like.](https://www.alt-counsel.com/content/images/2025/12/Screenshot-2025-12-28-at-10.41.54---PM.png)
...
2. **Volume ≠ Story** - Sometimes the shift is tone, not count.
...
And for anyone tracking the broader AI shift—from [prompt engineering workshops that felt wrong](https://www.alt-counsel.com/why-prompt-engineering-felt-wrong-and-what-skills-changed/) to [building agent-friendly tools](https://www.alt-counsel.com/i-built-cli-tools-for-claude-code-heres-what-i-learned-about-designing-for-ai-users/) to [understanding what actually creates value in AI work](https://www.alt-counsel.com/when-building-gets-cheap-but-knowing-stays-expensive/)—this keyword timeline captures the moment legal practice realized the technology had already changed the rules.
...
All the background work for this post—discussion notes, data files, SQL queries, chart generation scripts, and research documentation—is available in the [GitHub repository for this blog](https://github.com/houfu/blog-alt-counsel/tree/main/posts/year-in-review-2025).
