...
interrogation: {diagnosis: "takeaway 1 refined — see below", differentiation: "release-note forensics", framing_risk: "HIGH — see below", subject: "see below"}
...
target_date: ~
status: PITCH v1 — DRAFT FOR HOUFU'S APPROVAL. Not locked.
---
...
**1. Eleven years, and a good time** (~250w)
...
**3. The juniors gap** (~400w)
Refined claim: it is **not** that nobody is thinking about juniors. CJ Menon and Minister Tong co-lead an attrition-and-AI committee (Jan 2026); his Mass Call address in April was titled "Preparing and Supporting the Next Generation"; 1 in 3 new lawyers may quit within three years; 92% of new lawyers already use AI. The gap is that the juniors conversation is about *retention and wellbeing* and the AI conversation is about *throughput*, and **nobody owns the question of how a junior acquires judgment when the work that used to build it is the work being automated.** Neither-is-wrong lands here: Thomson Reuters Institute argues "AI will eliminate junior training" is a category error; Axios and Chambers argue the pipeline is narrowing. Neither is wrong. The nuance that matters: the trainable work isn't gone, it moved, and no one has volunteered to redesign the apprenticeship.

**4. The bigger bookcase** (~500w) — *the controversial one*
...
- **The LegalWeek Asia news** — unless Houfu says otherwise (see Open Questions). It is genuinely material but it is a different argument and would push past budget.
...
1. **Test the diagnosis.** The takeaway-1 framing as given ("focus remains on productivity, ROI, security" → juniors left behind) is **rebuttable in one sentence** — the CJ has given three major speeches on juniors in 2026. Refined above into the pastoral-vs-operational gap, which survives that rebuttal and is more interesting. **Houfu must confirm this refinement reflects what he actually saw.**
...
3. **Framing risk — HIGH.** "LawNet 4.0 sucks" targets a small, named, identifiable team (LawNet product staff post publicly under their own names). Precedent in this repo: `prompt-engineering-wrong` drew reviewer feedback that the TLF critique "borders on too critical," and the title was broadened from *TechLawFest Got Prompt Engineering Wrong* to *Lawyers Got Prompt Engineering Wrong*. **Recommendation: attack the strategy, never the execution or the people; lead with credit; source every criticism to SAL's own published material.** Then the piece is unrebuttable rather than merely spicy. Houfu to confirm intensity.
4. **Whose subject is this?** Risk: the LawNet section eats the post and the juniors takeaway becomes throat-clearing. Guard: beats 3 and 4 must be roughly balanced (400 / 500), and the close must land on both. If beat 4 runs past 600 words, split the post.

## Open questions for Houfu

1. `[HOUFU]` **The emotional opening.** Beat 1 cannot be written without your real reaction. What did the floor actually feel like this year compared to last?
2. `[HOUFU]` **LegalWeek Asia.** Announced *during* TLF 2026: from September 2027 TechLaw.Fest becomes "an anchor to the core program" inside Law.com/ALM's LegalWeek Asia. Is that a third takeaway, a line in the opening, or its own post?
3. `[HOUFU]` **How hard do we hit LawNet?** Strategy-critique with receipts (recommended) or keep the full heat of "LawNet 4.0 sucks"?
4. `[HOUFU]` **Does the refined juniors diagnosis match what you saw?** Or do you genuinely think the juniors conversation is absent, not merely disconnected?
5. `[HOUFU]` **Specifics for beat 2** — which sessions or booths gave you the productivity/ROI/security impression?
6. `[HOUFU]` **Your own LawNet experience** — one concrete task that took too long would carry beat 4 better than any release note.
7. `[HOUFU]` **Print LawNet pricing?** The SGD 206.92/month figure in the repo is from 2023 and must be re-verified before it appears.
